...
function [stimdrive supdrive attn observer] = init_parameters(varargin) 
...
bnds       = { [1 3]        [-1 0]           [1 3]        [-1 0]        [0.5 0.5]      [1 3]       [0 0]};
plaus_bnds = { [2 3]        [-0.3 -0.1]      [2 3]        [-0.7 -0.2]   [0.5 0.5]      [2 3]       [0 0]};
...
bnds =       {[1 4]              [-1 -0.01]            [1 3]         [1 30]             [0 0]             [1 8]             [0.1 1]              [0.1 0.95]       [1 12]};
plaus_bnds = {[2 3]              [-0.2 -0.1]           [1 2]         [5 15]             [0 0]             [2 6]             [0.5 1]              [0.5 0.8]        [2 10]};
